...
const ClinicProfitCalculator = () => {
  const [inputs, setInputs] = useState({
    clinicName: '',
    email: '',
    clinicType: 'chiro', // Fixed to chiropractic
    providers: 3,
    visitsPerWeek: 90,
    revenuePerVisit: 95,
    leadsPerMonth: 120,
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '50px', color: 'white' }}>
          ...
          <h1 style={{ fontSize: '56px', fontWeight: '800', marginBottom: '20px', lineHeight: '1.1' }}>
            Chiropractic<br/>Profit Leak Calculator
          </h1>
        ...
        {showResults && (
          <>
            ...
            <div style={{ background: '#f8fafc', padding: '20px', borderRadius: '12px', marginBottom: '24px', border: '2px solid #e2e8f0' }}>
              <p style={{ fontSize: '14px', color: '#1e3a8a', fontWeight: '600', marginBottom: '12px' }}>We'll analyze your business across 4 critical areas:</p>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '12px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><div style={{ width: '8px', height: '8px', background: '#3b82f6', borderRadius: '50%' }}></div><span style={{ fontSize: '13px', color: '#64748b' }}>Operations & Efficiency</span></div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><div style={{ width: '8px', height: '8px', background: '#10b981', borderRadius: '50%' }}></div><span style={{ fontSize: '13px', color: '#64748b' }}>Marketing & Lead Generation</span></div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><div style={{ width: '8px', height: '8px', background: '#8b5cf6', borderRadius: '50%' }}></div><span style={{ fontSize: '13px', color: '#64748b' }}>AI & Automation Systems</span></div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><div style={{ width: '8px', height: '8px', background: '#f59e0b', borderRadius: '50%' }}></div><span style={{ fontSize: '13px', color: '#64748b' }}>Revenue Optimization</span></div>
              </div>
            </div>

            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', marginBottom: '24px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <label style={{ fontSize: '14px', fontWeight: '600', color: '#1e3a8a' }}>Clinic Name *</label>
                <input 
                  type="text" 
                  value={inputs.clinicName} 
                  onChange={(e) => setInputs({...inputs, clinicName: e.target.value})} 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <label style={{ fontSize: '14px', fontWeight: '600', color: '#1e3a8a' }}>Email Address *</label>
                <input 
                  type="email" 
                  value={inputs.email} 
                  onChange={(e) => setInputs({...inputs, email: e.target.value})} 
            ...
            <p style={{ fontSize: '13px', color: '#64748b', marginTop: '8px', fontStyle: 'italic', lineHeight: '1.5' }}>
              Instant PDF download of your results • Personalized email with Steve CC'd for follow-up
            </p>

            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', marginBottom: '24px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <label style={{ fontSize: '14px', fontWeight: '600', color: '#1e3a8a' }}>Number of Providers</label>
                <input 
                  type="number" 
                  value={inputs.providers} 
                  onChange={(e) => setInputs({...inputs, providers: parseInt(e.target.value) || 0})} 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <label style={{ fontSize: '14px', fontWeight: '600', color: '#1e3a8a' }}>Visits Per Week</label>
                <input 
                  type="number" 
                  value={inputs.visitsPerWeek} 
                  onChange={(e) => setInputs({...inputs, visitsPerWeek: parseInt(e.target.value) || 0})} 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <label style={{ fontSize: '14px', fontWeight: '600', color: '#1e3a8a' }}>Revenue Per Visit</label>
                <input 
                  type="number" 
                  value={inputs.revenuePerVisit} 
                  onChange={(e) => setInputs({...inputs, revenuePerVisit: parseInt(e.target.value) || 0})} 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <label style={{ fontSize: '14px', fontWeight: '600', color: '#1e3a8a' }}>New Leads Per Month</label>
                <input 
                  type="number" 
                  value={inputs.leadsPerMonth} 
                  onChange={(e) => setInputs({...inputs, leadsPerMonth: parseInt(e.target.value) || 0})} 
            ...
            <div style={{ background: '#f8fafc', padding: '20px', borderRadius: '12px', marginBottom: '24px', border: '2px solid #e2e8f0' }}>
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#1e3a8a', marginBottom: '16px' }}>Current Performance Metrics</h3>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  <label style={{ fontSize: '14px', fontWeight: '600', color: '#1e3a8a' }}>Show Rate (%)</label>
                  <input 
                    type="number" 
                    value={inputs.currentShowRate} 
                    onChange={(e) => setInputs({...inputs, currentShowRate: parseInt(e.target.value) || 0})} 
                    placeholder="70"
                    style={{ width: '100%', padding: '12px', border: '2px solid #e2e8f0', borderRadius: '8px', fontSize: '14px', color: '#1e3a8a', fontWeight: '500', boxSizing: 'border-box' }} 
                  />
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  <label style={{ fontSize: '14px', fontWeight: '600', color: '#1e3a8a' }}>Lead to Book (%)</label>
                  <input 
                    type="number" 
                    value={inputs.currentLeadToBook} 
                    onChange={(e) => setInputs({...inputs, currentLeadToBook: parseInt(e.target.value) || 0})} 
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  <label style={{ fontSize: '14px', fontWeight: '600', color: '#1e3a8a' }}>Package Attach (%)</label>
                  <input 
                    type="number" 
                    value={inputs.currentPackageAttach} 
                    onChange={(e) => setInputs({...inputs, currentPackageAttach: parseInt(e.target.value) || 0})} 
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  <label style={{ fontSize: '14px', fontWeight: '600', color: '#1e3a8a' }}>Rebook Rate (%)</label>
                  <input 
                    type="number" 
                    value={inputs.currentRebookRate} 
                    onChange={(e) => setInputs({...inputs, currentRebookRate: parseInt(e.target.value) || 0})} 
            ...
            <div style={{ background: '#f8fafc', padding: '20px', borderRadius: '12px', marginBottom: '24px', border: '2px solid #e2e8f0' }}>
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#1e3a8a', marginBottom: '16px' }}>Choose Your Improvement Scenario</h3>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '12px' }}>
                {Object.values(improvements).map((scenario, index) => (
                  <button
                    key={index}
                    onClick={() => setScenario(scenario.label.toLowerCase())}
                    style={{
                      padding: '16px',
                      background: scenario.label.toLowerCase() === scenario ? 'linear-gradient(135deg, #3b82f6 0%, #1e40af 100%)' : 'white',
                      color: scenario.label.toLowerCase() === scenario ? 'white' : '#1e3a8a',
                      border: scenario.label.toLowerCase() === scenario ? 'none' : '2px solid #e2e8f0',
                      borderRadius: '12px',
                      fontSize: '14px',
                      fontWeight: '600',
                      cursor: 'pointer',
                    ...
                    onMouseEnter={(e) => {
                      if (currentImprovement.label !== scenario.label) {
                  ...
                  >
                    <div style={{ fontSize: '16px', fontWeight: '700', marginBottom: '4px' }}>{scenario.label}</div>
            ...
            {validationError && (
              <div style={{ background: '#fef2f2', border: '2px solid #fecaca', borderRadius: '12px', padding: '16px', marginBottom: '24px' }}>
                <p style={{ color: '#dc2626', fontSize: '14px', fontWeight: '600', margin: 0 }}>{validationError}</p>
              </div>
            )}
